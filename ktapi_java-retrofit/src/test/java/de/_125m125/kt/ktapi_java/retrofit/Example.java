...
public class Example {
    public static void main(final String[] args) throws InterruptedException {
        ...
        final KtRetrofitRequester requester = KtRetrofit.createDefaultRequester(new User("1", "1", "1"));
        final Result<List<Message>> history = requester.getMessages(user.getUID());
        try {
        ...
        final Result<Permissions> permissions = requester.getPermissions(user.getUID());
